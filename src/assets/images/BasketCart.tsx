...
export const BasketCart: React.FC = () => (
    <div style={{position: 'relative', display: 'inline-block', top: '7px'}}>
        <svg width="39" height="34" viewBox="0 0 39 34" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <defs>
                <filter id="filter0_d_478_4454" x="0" y="0" width="39" height="34" filterUnits="userSpaceOnUse"
                    ...
                    <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_478_4454"/>
                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_478_4454" result="shape"/>
                </filter>
            </defs>
        </svg>
    </div>
