...
export const NotificationBell: React.FC<NotificationBellProps> = ({ numberNotif }) => (
    <div style={{ position: 'relative', display: 'inline-block', top: '4px' }}>
        <svg width="25" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                fill="#4880FF"
            />
            <rect opacity="0.9" x="9.8252" y="19.75" width="6.04996" height="6" rx="2.25" fill="white" />
        </svg>
        {numberNotif > 0 && (
            <span
                style={{
